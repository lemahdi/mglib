...
xlw::XlfOper4& xlw::XlfOper4::SetElement(WORD r, WORD c, const XlfOper4 &value)
{
    if (!(lpxloper_->xltype & xltypeMulti))
        throw XlfException("attempt to perform an xltypeMulti operation on a value of type " + lpxloper_->xltype);
    xloper &element = lpxloper_->val.array.lparray[r * lpxloper_->val.array.columns + c];
...
WORD xlw::XlfOper4::rows() const {
    if (!(lpxloper_->xltype & xltypeMulti))
        throw XlfException("attempt to perform an xltypeMulti operation on a value of type " + lpxloper_->xltype);
    return lpxloper_->val.array.rows;
}

WORD xlw::XlfOper4::columns() const {
    if (!(lpxloper_->xltype & xltypeMulti))
        throw XlfException("attempt to perform an xltypeMulti operation on a value of type " + lpxloper_->xltype);
